...
export default function Hero() {
  ...
  return (
    <div
      className={`${responsiveClasses} flex  pt-10 h-screen items-center bg-gradient-to-br from-gray-50 to-blue-50/30`}
    >
      <div className="w-[58%]">
        <Image
          ref={imgRef}
          className="rounded-[14%_86%_22%_78%_/74%_26%_74%_26%] mb-5 w-[90%] shadow-2xl shadow-blue-200/40"
          src={Banner}
          width={1200}
          alt="Banner"
        />
      ...
      <div dir="rtl" className="w-[42%] flex flex-col">
        ...
        >
          ...
          تاکسی شو اسکن کن و سریع کرایه رو <br />
